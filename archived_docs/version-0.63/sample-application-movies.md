...
> 注意：此文档编写时间较早，组件采用 class 形式，可能与本网站其他函数式组件代码风格不一致，请留意写法上的区别。
...
##### 本文档贡献者：[sunnylqm](https://github.com/search?q=sunnylqm&type=Users)(99.38%), [949975358](https://github.com/search?q=949975358&type=Users)(0.62%)
